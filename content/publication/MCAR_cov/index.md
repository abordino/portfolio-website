...
publication: In *The Annals of Statistics*, **53**(5), 2204-2229. Supplementary material can be found [here](https://projecteuclid.org/journals/annals-of-statistics/volume-53/issue-5/Tests-of-missing-completely-at-random-based-on-sample-covariance/10.1214/25-AOS2540.short?tab=ArticleLinkSupplemental). The accompanying *R* package *MCARtest* is available from [CRAN](https://cran.r-project.org/web/packages/MCARtest/index.html). R code used for the simulations is available [here](https://github.com/abordino/MCAR_covariance)
publication_short: In *The Annals of Statistics*, **53**(5), 2204-2229. Supplementary material can be found [here](https://projecteuclid.org/journals/annals-of-statistics/volume-53/issue-5/Tests-of-missing-completely-at-random-based-on-sample-covariance/10.1214/25-AOS2540.short?tab=ArticleLinkSupplemental). The accompanying **R** package **MCARtest** is available from [CRAN](https://cran.r-project.org/web/packages/MCARtest/index.html). R code used for the simulations is available [here](https://github.com/abordino/MCAR_covariance)
