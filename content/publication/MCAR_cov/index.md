...
publication: In *The Annals of Statistics*, **53**(5), 2204-2229. The accompanying *R* package *MCARtest* is available from [CRAN](https://cran.r-project.org/web/packages/MCARtest/index.html). R code used for the simulations is available [here](https://github.com/abordino/MCAR_covariance)
publication_short: In *The Annals of Statistics*, **53**(5), 2204-2229. The accompanying **R** package **MCARtest** is available from [CRAN](https://cran.r-project.org/web/packages/MCARtest/index.html). R code used for the simulations is available [here](https://github.com/abordino/MCAR_covariance)
